class ValidationUtil {
  ...
  static bool isEmptyPassword(String password) {
    return password.isEmpty;
  }

  static bool isValidPassword(String password) {
    // contains at least 1 uppercase letter, 1 lowercase letter, 1 number and special character
    return RegExp(
      r'^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[!@#\$&*~_-])',
  ...
  static bool isValidUsername(String username) {
    return RegExp(r'^[a-zA-Z0-9_]{1,}[a-zA-Z0-9]$').hasMatch(username.trim());
  }
}
